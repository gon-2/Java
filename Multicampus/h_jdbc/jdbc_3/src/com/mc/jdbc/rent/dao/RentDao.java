...
public class RentDao {
	...
	public void insertRentBook(Connection conn, RentBook rentBook) {
		...
		// `RB_IDX`, `RM_IDX`, `BK_IDX`, `REG_DATE`, `STATE`, `RETURN_DATE`,
		// `EXTENSION_CNT`
	...
	public void insertRentHistoryWhenNewRent(Connection conn, int bkIdx, String state) {
		...
		String sql = "insert into rent_history(rm_idx, rb_idx, bk_idx, state)" + " values( " + getRentMasterLastIdx()
				+ ", " + getRentBookLastIdx() + ",  ?,?) ";
	...
	public void insertRentHistoryWhenChangeRent(Connection conn, int rbIdx, RentState re) {
		...
		String sql = "insert into rent_history(rm_idx, rb_idx, bk_idx, state) " + "values(" + rmIdx + ", ?," + bkIdx
				+ ", ? )";
