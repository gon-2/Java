...
public class A_프린트 {
	...
	public static void main(String[] args) {
		...
		// 1. println() : 매개변수로 전달된 값을 출력하고 개행(줄바꿈)
		...
		// 정렬방식 : %5d: 값을 표기하기 위해 5칸의 공간을 확보, 우측정렬
		...
		System.out.println();
		System.out.println("============================================================");
		System.out.printf("내 이름은 %s, 나이는 %d, 키는 %f 입니다.", "권용구", 19, 187.5);
		
		
		
		System.out.println();
		System.out.println("============================================================");
		System.out.printf("%10s : 5000원", "커피");
		System.out.println();
		System.out.printf("%10s : 10000원", "원두");
		System.out.println();
		System.out.printf("%10s : 50000", "커피캡슐");
		System.out.println();
		...
		System.out.println("나아아는\t자바가쉬워요");
		
		//16진수, 8진수 출력방법(자바는 10진수)
