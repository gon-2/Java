...
public class F_삼항연산자 {
	...
	public static void main(String[] args) {
		...
		int res1 = x > y ? x + y : x + y;
		int res2 = x > y ? x + y : x - y;
	...
	private static void q2() {
		...
		String res4 = input > 0 ? "양수" : input < 0 ? "음수" : "0";
	...
	private static void q1() {
		...
		// 입력받는 문자가 'y' 또는 'Y' 아니라면 '잘못 입력하셨습니다.'
		// 를 출력하는 코드를 작성하시오
		
		Scanner sc = new Scanner(System.in);
		System.out.print("y또는 Y를 입력하세요 : ");
		String input = sc.nextLine();
		String res3 = input.equals("y") || input.equals("Y") ? "y를 입력하셨습니다." : "잘못 입력하셨습니다.";
